    ...
    public void calculateSalaries(String fileName){
        ...
        try {
            ...
            if(nameNmoney.length != 2){
                System.out.println(line + "formatted wrong. Make sure it is --> name,number");
                continue;
            }
...
//OKAY NOW WE HAVE THE EMPLOYEE OBJECT SET. NOW DEALING WITH MONEY,
                ...
                System.out.printf("%s has monthly salary of %s dollars.", name, monthlySalary);


            }//close bracket for while has next Line
//this means we are done reading the file
        }catch(IOException e){ System.out.println("Problem finding/reading the .csv file. Make sure you wrote the path correctly.");}
